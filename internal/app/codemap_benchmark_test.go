...
func TestCodemapHelpListsBenchmark(t *testing.T) {
	...
	if !strings.Contains(stdout.String(), "{fix,check,inspect,export,benchmark,precision}") || !strings.Contains(stdout.String(), "missing-link benchmark") || !strings.Contains(stdout.String(), "precision") {
