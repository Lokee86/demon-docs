...
| `internal/codemaparcana/` | Arcana/Lexicon snapshot alignment, source-freshness gating, JSONL protocol transport, and exact file/symbol target resolution | [Codemap Extraction and Dataset](../architecture/codemap-extraction-and-dataset.md), [Codemap Pipeline](../architecture/codemap-pipeline.md) |
| `internal/codemapcorpus/` | Repository files, code-intelligence provider boundary, local fallback dependency/symbol adapters, history, and related-document facts | [Codemap Corpus and Adapters](../architecture/codemap-corpus-adapters.md), [Codemap Pipeline](../architecture/codemap-pipeline.md) |
