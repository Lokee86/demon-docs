...
| Every admitted recommendation receives one deterministic role without changing score, ordering, hard-link thresholds, or mutation eligibility | [Codemap Evidence and Ranking](../architecture/codemap-evidence-and-ranking.md), [Codemap Missing-Link Algorithm](../codemap-suggestion-algorithm.md) | `internal/codemaprecommend/roles_test.go`, role-preserves-tier test, precision role-validation/breakdown tests | `go test ./internal/codemaprecommend ./internal/codemapbench ./internal/codemapprecision ./internal/app -count=1` |
