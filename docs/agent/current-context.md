...
- Markdown heading-fragment validation remains unimplemented. Stable schema-1 machine-readable diagnostics are implemented for links, documentation indexes, and frontmatter, including combined reports; document format, reverse indexes, and suitable runtime/configuration failures still need migration onto the shared envelope.
