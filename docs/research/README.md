...
Research claims must state their sample, corpus, conditions, and limitations. Decisions derived from research must also update current or planning documentation.
