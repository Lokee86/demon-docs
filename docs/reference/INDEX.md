...
- [machine-readable-diagnostics.md](machine-readable-diagnostics.md) - Versioned JSON diagnostic envelope, stable link/index/frontmatter/format codes, severity values, and compatibility rules.
